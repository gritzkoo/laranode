<link rel="stylesheet" href="{{asset('assets/jquery-ui-1.11.4.custom/jquery-ui.css') }}">
<link rel="stylesheet" href="{{asset('assets/bootstrap-4.0.0-alpha.6-dist/css/bootstrap.css') }}">
<script src="https://cdnjs.cloudflare.com/ajax/libs/socket.io/2.0.4/socket.io.js"></script>
<script src="{{ asset('assets/jquery-ui-1.11.4.custom/external/jquery/jquery.js') }}"></script>
